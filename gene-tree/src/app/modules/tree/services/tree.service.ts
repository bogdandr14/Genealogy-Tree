  ...
  private initCustomTemplate() {
    ...
    FamilyTree.templates.gene.defs = `<clipPath id="gene_img_0"><rect id="gene_img_0_stroke" stroke-width="2" stroke="#fff" x="90" y="-5" rx="25" ry="25" width="70" height="70"></rect></clipPath>
        ...
        <linearGradient id="gene_grad_other" x1="0%" y1="0%" x2="100%" y2="0%">
            ...
            <stop offset="65%" style="stop-color:cyan;stop-opacity:1" />
            <stop offset="80%" style="stop-color:blue;stop-opacity:1" />
            <stop offset="95%" style="stop-color:purple;stop-opacity:1" />
        </linearGradient>
        <g id="gene_up">
    ...
    FamilyTree.templates.gene['field_0'] = `<text ' + FamilyTree.attr.width + ' ="230" style="font-size: 18px;font-weight:bold;" fill="#ffffff" x="125" y="85" text-anchor="middle">{val}</text>`;
    ...
    FamilyTree.templates.gene['field_2'] = `<g transform="translate(10,10)">
                                              <a xlink:href="${userProfileLink}/{val}">
    ...
    FamilyTree.templates.gene['up'] = `<use x="200" y="10" xlink:href="#gene_up"/>`;
